...
[Acessar Repositório Barberix](https://github.com/Douglas-Felipe-Mariano/Barberix)

#### 2. Maderix (Contribuição em Equipe)
* **Foco:** Sistema de gerenciamento de estoque e controle financeiro para marcenarias. (Demonstra vivência em domínios de negócio complexos, como financeiro e logística).
* **Minha Contribuição:** Atuação ativa no desenvolvimento e manutenção do **Backend** e da **API**, utilizando **Java/Spring** e **SQL Server**.
* **Stack:** **Java**, **Spring**, **JWT**, **React** e **SQL Server**.
 
[Acessar Repositório Maderix](https://github.com/cleitongrodrigues/Maderix)
